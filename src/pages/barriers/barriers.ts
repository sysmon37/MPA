...
export class BarriersPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private dataService : DataProvider) {
    this.items = [
      ...
      {title: "I believe medicines are all poisonous and I should avoid taking medicines at all if possible", action: "", targetPage: ""},
      ...
      {title: "I fail to take my medicines every day automatically at a fixed time or on fixed occasions", action: "Use basic techniques to create reminders (post-it notes, calendar, alerts, etc.) and to establish routine", hint: "Use the calendar function to define relevant alerts", targetPage: "ActionPlanCalendarPage"},
      {title: "Generally I often feel bad, and sometimes I feel discouraged and depressed", action: "", targetPage: ""},
      {title: "I really would need help on an everyday basis (and particularly related to my treatment with medicines), but I do not get any help", action: "", targetPage: ""},
