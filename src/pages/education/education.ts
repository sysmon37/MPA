...
export class EducationPage {
  ...
  openItemDetailPage(item) {
    ...
    if (item.targetPage == "EducationDetailPage")
      params = {item: item, title: item.alternativeTitle};
