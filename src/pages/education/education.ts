  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private dataService: DataProvider) {
    ...
    this.itemGroups = [
     ...
     { 
      ...
      items: [
        {targetPage: "EducationDetailPage", title: 'Why is anticoagulation important?', scenarios: [1, 2], content: 'AFib is a cause of cardiovascular complications (for example, it can aggravate heart failure), and it causes a reduction in tolerance to physical activity. However, the most severe complication is caused by stagnation of blood in the atrial chambers (due to the loss of coordinated contraction). This promotes the formation of blood clots (thrombi) on the walls of the atrium. If the blood clot detaches it is often dragged by the blood flow to the arteries of the brain (due to anatomical reasons) so they can become clogged causing a stroke. For this reason, patients with AFib are commonly treated with anticoagulant drugs.'},
        {targetPage: "EducationDetailPage", title: 'What are direct oral anticoagulants (DOACs)?', scenarios: [1, 2], content: 'to be provided...'},
        {targetPage: "EducationDetailPage", title: 'How does impaired renal function affect DOAC dosing?', scenarios: [1, 2], content: 'to be provided...'},
        {targetPage: "EducationDetailPage", title: 'How long does the antithrombotic effect of DOACs last?', scenarios: [1, 2], content: 'to be provided...'},
      ]
     }      
    ];
