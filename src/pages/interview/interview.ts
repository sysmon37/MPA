...
export class InterviewPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    this.items = [
      {question: 'Do you have any obstacles from compliance?',  
      ...
      {question: 'Did you get your knowledge from physicians?',  
      ...
      {question: 'Why did you have the ablation procedure?',  
      ...
      {question: 'Does dietary care bother you?',  
      ...
      {question: 'Do you fear AFib episodes?',  
      ...
      {question: 'Did your symptoms improve after the ablation?',  
      ...
      {question: 'What does it mean to you to be engaged in your treatment?',  
