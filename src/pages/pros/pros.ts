  ...
  ionViewWillEnter(){
    ...
    if (this.dataService.getUnderstoodPros().length >= this.dataService.MIN_UNDERSTOOD_PROS && this.dataService.getShowCommitmentPopup()) {
      let alert = this.alertCtrl.create({
          ...
          subTitle: 'You have realized different kinds of well-being that may result from my engagement and compliance. This is a first significant step in which you have demonstrated your commitment',
          buttons: ['OK']
       });
      alert.present();        
